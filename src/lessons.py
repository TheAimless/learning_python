...
class learnWindow(appCore.windowClass):
    ...
    def setupWidget(self):
        ...
        self.widget.createBtn("node_3", "Back", False)
        ...
        self.widget.createLabel("temp", "Temp")
        self.horizontalLayout.addWidget(self.widget.temp_label)
        ...
        self.scrollAreaWidgetContents_3.createLabel("temp3", "Temp3")
        self.scrollAreaWidgetContents_3.temp3_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.verticalLayout_7.addWidget(self.scrollAreaWidgetContents_3.temp3_label)
